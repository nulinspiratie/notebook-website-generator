                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        if (set.showURL)
                                        {
                                             if (set.relativePath === true && typeof base_path !== "undefined"){
                                               var url = base_path + '/' + found[i].url;
                                               var s_u = found[i].url;
                                             } else {
                                               var url = found[i].url;
                                             ...
                                             out += '<div class="tipue_search_content_url"><a href="' + url + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }
